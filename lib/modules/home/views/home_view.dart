...
import 'package:yessine/modules/details/views/details_view.dart';
import 'package:yessine/modules/library/controllers/library_controller.dart';
import 'package:yessine/modules/library/views/library_view.dart';
import 'package:yessine/modules/login/views/login_view.dart';
import 'package:yessine/shared/textfFiled.dart';
        ...
        children: [
          Container(
            ...
            child: Column(
              ...
              children: [
                // Texte d'accueil avec GestureDetector pour rediriger vers la page de login
                GestureDetector(
                  onTap: () {
                    Get.to(() => LoginView()); // Navigation vers la page de connexion
                  },
                  child: Obx(() {
                    // Utilisez le nom de l'utilisateur dynamique
                    return Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(
                          "Hi, ${imageController.username.value}!", // Affiche le nom de l'utilisateur
                          style: TextStyle(
                            color: Colors.white,
                            fontSize: 30,
                        ...
                        return GestureDetector(
                          ...
                          child: Chip(
                            ...
                            backgroundColor: isSelected
                                ? const Color.fromRGBO(134, 16, 253, 1)
                                : Colors.grey[900],
